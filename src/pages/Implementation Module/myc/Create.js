...
export default function Tabs() {
  const [activeTab, setActiveTab] = useState("contractual");
  ...
  return (
    <div>
      <div className="flex border-b overflow-auto whitespace-nowrap text-sm">
        <button
        ...
        <button
          ...
          onClick={() => setActiveTab("non_contractual")}
        >
          Non-Contractual
        </button>
        <button
          ...
          onClick={() => setActiveTab("counterpart")}
        >
          Counterpart
        </button>
        <button
          ...
          onClick={() => setActiveTab("add_myc_info")}
        >
      ...
      <div>
        {activeTab === "contractual" ? (
          ...
          <div className="p-4">Content for Counterpart</div>
        ) : activeTab === "add_myc_info" ? (
          <div className="p-4">Content for Additional MYC Information</div>
        ) : (
          <div className="p-4">
            <NonContractual />
          </div>
